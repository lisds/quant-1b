...
DataFrame `by_nei`.  Create another DataFrame called `by_nei_pter` that's
sorted in decreasing order by NEI-PTER instead.
...
**Question 3.** Make a DataFrame containing the data for the 10 quarters when
NEI was greatest.  Call that DataFrame `greatest_nei`.
